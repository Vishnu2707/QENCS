import { ChartOffsetRequired, Margin, Size } from '../../util/types';
...
export declare const selectChartOffset: (state: RechartsRootState) => ChartOffsetRequired;
export declare const selectChartViewBox: ((state: import("redux").EmptyObject & {
    ...
    resultFunc: (resultFuncArgs_0: Required<import("../../util/types").ChartOffset>) => Required<import("../../util/types").CartesianViewBox>;
    memoizedResultFunc: ((resultFuncArgs_0: Required<import("../../util/types").ChartOffset>) => Required<import("../../util/types").CartesianViewBox>) & {
        clearCache: () => void;
        resultsCount: () => number;
        resetResultsCount: () => void;
    };
    lastResult: () => Required<import("../../util/types").CartesianViewBox>;
    dependencies: [(state: RechartsRootState) => ChartOffsetRequired];
