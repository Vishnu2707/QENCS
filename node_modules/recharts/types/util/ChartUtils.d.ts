...
import { AxisTick, AxisType, BaseAxisProps, ChartCoordinate, ChartOffset, DataKey, LayoutType, NumberDomain, OffsetHorizontal, OffsetVertical, PolarViewBox, RangeObj, Size, StackOffsetType, TickItem } from './types';
...
export declare function getValueByDataKey<T>(obj: T, dataKey: DataKey<T>, defaultValue?: any): unknown;
 ...
 * radial -> radius
 */
coordinate: number, ticks: ReadonlyArray<TickItem>, unsortedTicks: ReadonlyArray<TickItem> | undefined, axisType: AxisType | undefined, range: AxisRange | undefined) => number;
...
export declare const getDomainOfStackGroups: (stackGroups: Record<StackId, ChildStackGroup>, startIndex: number, endIndex: number) => NumberDomain;
...
export declare function getTooltipNameProp(nameFromItem: string | number | undefined | unknown, dataKey: DataKey<any>): string | undefined;
export declare function inRange(x: number, y: number, layout: LayoutType, polarViewBox: PolarViewBox | undefined, offset: ChartOffset): RangeObj;
