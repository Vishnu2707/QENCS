export declare const ComposedChart: import("react").ForwardRefExoticComponent<import("./generateCategoricalChart").CategoricalChartProps & import("react").RefAttributes<{
    ...
    getSnapshotBeforeUpdate?(prevProps: Readonly<import("./generateCategoricalChart").CategoricalChartProps>, prevState: Readonly<import("./types").CategoricalChartState>): any;
    componentDidUpdate?(prevProps: Readonly<import("./generateCategoricalChart").CategoricalChartProps>, prevState: Readonly<import("./types").CategoricalChartState>, snapshot?: any): void;
