...
import React, { Component, PureComponent, useCallback, useMemo, useRef, useState } from 'react';
...
function LineImpl(props) {
  ...
  var points = useAppSelector(state => selectLinePoints(state, props.xAxisId, props.yAxisId, isPanorama, lineSettings));
