...
var selectDisplayedData = exports.selectDisplayedData = (0, _reselect.createSelector)([_dataSelectors.selectChartDataAndAlwaysIgnoreIndexes, pickPieSettings, pickCells], (_ref, pieSettings, cells) => {
  var _pieSettings$data;
  var {
    chartData
  } = _ref;
  var displayedData;
  if ((pieSettings === null || pieSettings === void 0 || (_pieSettings$data = pieSettings.data) === null || _pieSettings$data === void 0 ? void 0 : _pieSettings$data.length) > 0) {
...
var selectPieLegend = exports.selectPieLegend = (0, _reselect.createSelector)([selectDisplayedData, pickPieSettings, pickCells], (displayedData, pieSettings, cells) => {
...
var selectSynchronisedPieSettings = (0, _reselect.createSelector)([_polarSelectors.selectUnfilteredPolarItems, pickPieSettings], (graphicalItems, pieSettingsFromProps) => {
...
var selectPieSectors = exports.selectPieSectors = (0, _reselect.createSelector)([selectDisplayedData, selectSynchronisedPieSettings, pickCells, _selectChartOffset.selectChartOffset], (displayedData, pieSettings, cells, offset) => {
