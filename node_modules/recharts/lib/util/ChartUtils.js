...
var getTicksOfAxis = (axis, isGrid, isAll) => {
  ...
  offset = axisType === 'angleAxis' && (range === null || range === void 0 ? void 0 : range.length) >= 2 ? (0, _DataUtils.mathSign)(range[0] - range[1]) * 2 * offset : offset;
...
var getDomainOfStackGroups = (stackGroups, startIndex, endIndex) => makeDomainFinite(Object.keys(stackGroups).reduce((result, stackId) => {
