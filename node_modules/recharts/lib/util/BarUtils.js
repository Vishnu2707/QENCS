...
var minPointSizeCallback = exports.minPointSizeCallback = function minPointSizeCallback(minPointSize) {
  ...
  return (value, index) => {
    ...
    var isValueNumber = (0, _DataUtils.isNumber)(value);
    if (isValueNumber) {
      return minPointSize(value, index);
    }
    !isValueNumber ? process.env.NODE_ENV !== "production" ? (0, _tinyInvariant.default)(false, "minPointSize callback function received a value with type of ".concat(typeof value, ". Currently only numbers are supported.")) : (0, _tinyInvariant.default)(false) : void 0;
    return defaultValue;
  };
};