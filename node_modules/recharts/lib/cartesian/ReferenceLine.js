...
var getEndPoints = (scales, isFixedX, isFixedY, isSegment, viewBox, position, xAxisOrientation, yAxisOrientation, props) => {
  ...
  if (isSegment) {
    ...
    if (props.ifOverflow === 'discard' && (0, _some.default)(_points2, p => !scales.isInRange(p))) {
      return null;
    }
    return _points2;
  }
...
function ReferenceLineSettingsDispatcher(props) {
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(ReportReferenceLine, {
    yAxisId: props.yAxisId,
    xAxisId: props.xAxisId,
    ifOverflow: props.ifOverflow,
    x: props.x,
    y: props.y
  }), /*#__PURE__*/_react.default.createElement(ReferenceLineImpl, props));
}

// eslint-disable-next-line react/prefer-stateless-function
class ReferenceLine extends _react.Component {
  render() {
    return /*#__PURE__*/_react.default.createElement(ReferenceLineSettingsDispatcher, this.props);
  }
}
