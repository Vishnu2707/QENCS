...
import { ActiveTooltipProps, TooltipIndex, TooltipInteractionState, TooltipPayload, TooltipPayloadConfiguration, TooltipPayloadSearcher } from '../tooltipSlice';
import { ChartDataState } from '../chartDataSlice';
import { AxisType, BaseAxisProps, ChartOffset, Coordinate, DataKey, LayoutType, PolarViewBox, TickItem, TooltipEventType } from '../../util/types';
import { TooltipTrigger } from '../../chart/types';
import { ChartPointer } from '../../chart/generateCategoricalChart';
import { AxisRange } from './axisSelectors';
export declare const useChartName: () => string;
export declare const selectOrderedTooltipTicks: ((state: import("redux").EmptyObject & {
    ...
    lastResult: () => TickItem[];
    dependencies: [(state: RechartsRootState) => ReadonlyArray<TickItem> | null];
...
export declare const selectTooltipDataKey: (state: RechartsRootState, tooltipEventType: TooltipEventType, trigger: TooltipTrigger) => DataKey<any> | undefined;
...
export declare const selectActiveLabel: (state: RechartsRootState, tooltipEventType: TooltipEventType, trigger: TooltipTrigger, defaultIndex: TooltipIndex | undefined) => string | undefined;
...
export declare const combineActiveProps: (chartEvent: ChartPointer | undefined, layout: LayoutType | undefined, polarViewBox: PolarViewBox | undefined, tooltipAxisType: AxisType | undefined, tooltipAxisRange: AxisRange | undefined, tooltipTicks: ReadonlyArray<TickItem> | undefined, orderedTooltipTicks: ReadonlyArray<TickItem> | undefined, offset: ChartOffset) => ActiveTooltipProps;
