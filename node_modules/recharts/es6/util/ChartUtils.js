...
export var getTicksOfAxis = (axis, isGrid, isAll) => {
  ...
  offset = axisType === 'angleAxis' && (range === null || range === void 0 ? void 0 : range.length) >= 2 ? mathSign(range[0] - range[1]) * 2 * offset : offset;
...
export var getDomainOfStackGroups = (stackGroups, startIndex, endIndex) => makeDomainFinite(Object.keys(stackGroups).reduce((result, stackId) => {
