...
function parseNumericalUserDomain(userDomain, dataDomain, allowDataOverflow) {
  ...
  if (Array.isArray(userDomain) && userDomain.length === 2) {
    ...
    if (providedMin === 'auto') {
      ...
      var value = +_ChartUtils.MIN_VALUE_REG.exec(providedMin)[1];
      // eslint-disable-next-line no-unsafe-optional-chaining
      finalMin = (dataDomain === null || dataDomain === void 0 ? void 0 : dataDomain[0]) - value;
    } else {
    ...
    if (providedMax === 'auto') {
      ...
      var _value = +_ChartUtils.MAX_VALUE_REG.exec(providedMax)[1];
      // eslint-disable-next-line no-unsafe-optional-chaining
      finalMax = (dataDomain === null || dataDomain === void 0 ? void 0 : dataDomain[1]) + _value;
    } else {
