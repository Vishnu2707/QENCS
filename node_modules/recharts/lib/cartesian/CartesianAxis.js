...
class CartesianAxis extends _react.Component {
  ...
  static renderTickItem(option, props, value) {
    ...
    if (/*#__PURE__*/_react.default.isValidElement(option)) {
      ...
      if (typeof option !== 'boolean') {
        className = (0, _clsx.default)(className, option.className);
      }
  ...
  renderTicks(fontSize, letterSpacing) {
    ...
    return items.length > 0 ? /*#__PURE__*/_react.default.createElement("g", {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_Layer.Layer, {
      ...
      ref: _ref2 => {
        if (_ref2) {
          var tick = _ref2.getElementsByClassName('recharts-cartesian-axis-tick-value')[0];
          if (tick) {
